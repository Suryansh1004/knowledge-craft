  ...
  'general-discussion': [
    {
      ...
      userId: 'user123',
      userName: 'TechGuru',
      userAvatar: 'https://picsum.photos/seed/user1/250/250',
    ...
    },
    {
      ...
      userId: 'user456',
      userName: 'CodeWizard',
      userAvatar: 'https://picsum.photos/seed/user2/250/250',
  ...
  'web-development-help': [
    {
      ...
      userId: 'user789',
      userName: 'ReactFan',
      userAvatar: 'https://picsum.photos/seed/user3/250/250',
    ...
    },
     {
      ...
      userId: 'user101',
      userName: 'CSSMaster',
      userAvatar: 'https://picsum.photos/seed/user4/250/250',
